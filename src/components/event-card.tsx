...
export const EventCard: React.FC<EventCardProps> = ({
  ...
  const imageContent = (
    <div className="relative h-48 w-full"> {/* This div ensures the height and width */}
      <Image
        src={image}
        alt={name}
        fill
  ...
  const titleContent = (
    <>
      ...
      <div className="flex items-center text-gray-300 text-sm">
        ...
        {formattedDate}
        <span className="mx-2">{String.fromCharCode(8226)}</span> {/* Replaced • with Unicode escape */}
  ...
  return (
    <CardBase imageSlot={imageContent} titleSlot={titleContent}>
